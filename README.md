...
## Result
![Relative date](https://img.shields.io/date/1784505386?label=Updated)
...
|glusterfs|11.1|11.2||
|gnupg|2.5.20|2.5.21||
|go-github-ajg-form|1.7.1|1.8.0||
...
|go-github-apache-arrow-go-v18|18.5.0|18.7.0-rc0||
...
|go-github-aws-smithy-go|2025.12.01|1.27.4|Possible downgrade from the current version (2025.12.01 -> 1.27.4)|
...
|go-github-go-openapi-swag|0.26.1|yamlutils/v0.27.1||
...
|go-github-mattn-go-isatty|0.0.22|0.0.23||
...
|go-github-prometheus-client-golang|1.23.2<br>+git20260717.78262a7|1.24.0-rc.0|Compound version number '1.23.2+git20260717.78262a7'<br>Version number indicates a snapshot (+git) is used|
...
|python-dashscope|1.25.11|1.26.4||
...
|python-expandvars|1.1.2|1.24.4||
...
|python-platformdirs|4.9.6|4.10.1||
...
|python-prometheus-fastapi-instrumentator|7.1.0|8.0.3.dev2||
...
|valkey|8.1.4|9.1.0||
|vapoursynth|73|77||
|vim|9.2.0593|9.2.0810||
|vmaf|3.0.0|3.2.0||
|vte|0.82.3|3.4.3||
|vulkan-headers|1.4.335.0|1.4.357||
|vulkan-loader|1.4.335.0|1.4.357||
|vulkan-tools|1.4.335|1.4.357||
|vulkan-utility-libraries|1.4.335.0|1.4.357||
|vulkan-validation-layers|1.4.335.0|1.4.357||
|wabt|1.0.39|1.0.41||
|wavpack|5.8.1|5.9.0||
|wayback|0.3|0.5.1||
