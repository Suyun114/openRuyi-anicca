...
## Result
![Relative date](https://img.shields.io/date/1779813743?label=Updated)
...
|go-github-apache-beam|2.71.0|2.74.0-RC2||
...
|go-github-brianvoe-gofakeit|7.14.0|7.15.0||
...
|libyang|4.2.2|5.4.9||
|linux|7.0.10|7.0|Possible downgrade from the current version (7.0.10 -> 7.0)|
...
|python-boto3|1.43.6|1.43.14||
|python-botocore|1.43.11|1.43.14||
...
|python-dashscope|1.25.11|1.25.19||
...
|python-hypothesis|6.152.4|6.153.0||
...
|python-numpy|2.4.0|2.6.0.dev0||
|python-opentelemetry-api|1.41.1|1.42.1||
|python-opentelemetry-semantic-conventions|0.62b1|1.42.1||
