...
## Result
![Relative date](https://img.shields.io/date/1785166939?label=Updated)
...
|python-fastapi|0.136.1|0.140.3||
...
|python-huggingface-hub|1.5.0|1.25.1||
|python-hypothesis|6.152.4|6.161.6||
...
|rust-toml-0.9|0.9.12|toml_parser-v1.1.3||
|rust-toml-datetime-0.7|0.7.5|toml_parser-v1.1.3||
