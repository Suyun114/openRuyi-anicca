...
## Result
![Relative date](https://img.shields.io/date/1787610263?label=Updated)
...
|go-github-aws-smithy-go|2025.12.01|1.27.9|Possible downgrade from the current version (2025.12.01 -> 1.27.9)|
...
|go-github-go-openapi-spec|0.22.6|0.22.10||
...
|go-github-lithammer-shortuuid|4.2.0|4.3.0||
...
|go-github-yuin-goldmark|1.8.2|2.0.0-rc.3||
...
|python-boto3|1.43.75|1.43.79||
|python-botocore|1.43.75|1.43.79||
...
|python-dashscope|1.25.11|1.27.1||
...
|python-linkify-it-py|2.1.0|2.1.1||
...
|python-platformdirs|4.9.6|4.11.4||
...
|python-torchvision|0.28.0|0.29.0-rc1||
|python-tqdm|4.67.3|4.70.0||
|python-traitlets|5.15.0|5.16.1||
|python-transformers|5.12.1|5.15.1||
...
|rust-wit-bindgen-0.51|0.51.0|0.61.0||
|rust-wit-bindgen-core-0.51|0.51.0|0.61.0||
|rust-wit-bindgen-rust-0.51|0.51.0|0.61.0||
|rust-wit-bindgen-rust-macro-0.51|0.51.0|0.61.0||
|rust-wit-component-0.244|0.244.0|1.258.0||
|rust-wit-parser-0.244|0.244.0|1.258.0||
|ruyi|0.46.0|0.52.0-beta.20260824||
