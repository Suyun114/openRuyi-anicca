...
## Result
![Relative date](https://img.shields.io/date/1785047734?label=Updated)
...
|cunit|2.1.3|2.1-3||
|curl|8.20.0|8.21.0||
|curl-impersonate-chrome|0.7.0|2.0.0rc5||
|date|3.0.4|3.5.1||
|dav1d|1.5.3|1.5.4||
|db|6.2.32|18.1.40||
|dbus|1.16.2|5.2.2||
...
|go-github-docker-go-connections|0.7.0|0.8.0||
...
|python-boto3|1.43.6|1.43.56||
|python-botocore|1.43.11|1.43.56||
...
|python-fastapi|0.136.1|0.140.0||
|python-fastavro|1.12.1|1.12.2||
|python-fastjsonschema|2.21.2|2.22.0||
...
|python-hypothesis|6.152.4|6.161.5||
