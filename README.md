...
## Result
![Relative date](https://img.shields.io/date/1784007050?label=Updated)
...
|glusterfs|11.1|11.2||
|gnupg|2.5.20|2.5.21||
|go-github-ajg-form|1.7.1|1.7.3||
|go-github-ajstarks-svgo|2012.01.27|go.weekly.2012-01-27||
|go-github-alecthomas-repr|0.5.2|0.5.3||
|go-github-andybalholm-brotli|1.2.1|1.2.2||
|go-github-anishathalye-porcupine|1.2.0|1.3.0||
|go-github-apache-arrow-go-arrow|0<br>+git20260107.bc21918|apache-arrow-26.0.0.dev|Compound version number '0+git20260107.bc21918'<br>Version number indicates a snapshot (+git) is used<br>Possible downgrade from the current version (0+git20260107.bc21918 -> apache-arrow-26.0.0.dev)|
...
|go-github-dlclark-regexp2|1.12.0|2.5.0||
...
|go-github-prometheus-common|0.69.0|0.70.0||
...
|go-github-yuin-goldmark|1.8.2|2.0.0-beta.5||
...
|python-dashscope|1.25.11|1.26.3||
...
|python-regex|2026.1.15|2026.7.11||
...
|python-transformers|5.2.0|5.13.1||
...
|python-virtualenv|20.35.4|21.6.1||
...
|ruyi|0.46.0|0.51.0-beta.20260714||
...
|spirv-llvm-translator|22.1.3|22.1.4||
