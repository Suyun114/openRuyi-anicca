...
## Result
![Relative date](https://img.shields.io/date/1783119675?label=Updated)
...
|go-github-apache-arrow-go-arrow|0<br>+git20260107.bc21918|apache-arrow-25.0.0-rc1|Compound version number '0+git20260107.bc21918'<br>Version number indicates a snapshot (+git) is used<br>Possible downgrade from the current version (0+git20260107.bc21918 -> apache-arrow-25.0.0-rc1)|
|go-github-apache-arrow-go-v18|18.5.0|18.6.0||
|go-github-apache-beam|2.74.0|2.75.0-RC1||
|go-github-apparentlymart-go-textseg|16.0.0|17.0.0||
...
|go-github-lesismal-nbio|1.6.9|1.6.11||
...
|go-github-prometheus-procfs|0.19.2|0.21.1||
...
|go-github-yuin-goldmark|1.8.2|2.0.0-beta.1||
...
|libxmlb|0.3.24|0.3.28||
|libxslt|1.1.43|1.1.45||
|libyang|4.2.2|5.8.6||
|lighttpd|1.4.82|1.4.84||
|linux|7.1.2|7.1|Possible downgrade from the current version (7.1.2 -> 7.1)|
...
|python-narwhals|2.15.0|2.23.0||
|python-networkx|3.6.1|networkx-3.6.1|Possible downgrade from the current version (3.6.1 -> networkx-3.6.1)|
|python-numpy|2.4.6|2.5.0||
|python-opentelemetry-api|1.42.1|1.43.0||
|python-opentelemetry-semantic-conventions|0.63b1|1.43.0||
...
|python-pyproject-metadata|0.9.1|0.12.0||
...
|python-torchvision|0.25.0|0.28.0-rc4||
...
|spirv-llvm-translator|21.1.3|22.1.4||
